...
![Architecture overview](results/architecture_overview.png)
...
The figure below shows examples from the reconstruction pipeline. Each row compares the scrambled input patches, the differentiable soft canvas, the final prediction, and the ground-truth image.

![Qualitative reconstruction examples](results/qualitative_examples.png)
